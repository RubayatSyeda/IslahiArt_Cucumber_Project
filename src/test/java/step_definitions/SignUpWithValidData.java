...
public class SignUpWithValidData {
    ...
    private static final Logger logger = LogManager.getLogger(SignUpWithValidData.class);
    ...
    public void clickCheckbox() {
        WebElement checkbox =  driver.findElement(By.xpath("(//input[@name = 'xoo_el_reg_terms'])[1]"));
